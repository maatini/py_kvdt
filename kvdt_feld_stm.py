...
Liste alle Feldkennungen mit den Attributen
    ...
    Type-Info:
        min, max, 'a'   : alphanumerisch mit Länge im Bereich [min, max]
        'd'             : Datum, Längenangaben optional
        'g'             : GOP
        min, max, 'n'   : numerisch mit Länge im Bereich [min, max]
        'z'             : Zeitraum
...
'0201':  ['Betriebs- (BSNR) oder Neben-betriebsstättennummer (NBSNR)', [9, 9, 'n']] ,
...
'0212':  ['Lebenslange Arztnummer (LANR)', [9, 9, 'n']] ,
...
'0300':  ['Abrechnung von (zertifikats-pflichtigen) Laborleistungen', [1, 1, 'n']] ,
'0301':  ['pnSD/uu-Analysen', [1, 1, 'n']] ,
'0302':  ['Gerätetyp', [0, 60, ALPHANUMERISCH]] ,
'0303':  ['Hersteller', [0, 60, ALPHANUMERISCH]] ,
'0304':  ['Analyt-ID', [3, 3, 'n']] ,
'0305':  ['RV-Zertifikat', [1, 1, 'n']] ,
'3000':  ['Patientennummer', [0, 20, ALPHANUMERISCH]] ,
'3003':  ['Schein-ID', [0, 60, ALPHANUMERISCH]] ,
'3004':  ['Kartentyp/-generation eGK', [1, 1, 'n']] ,
...
'3103':  ['Geburtsdatum des Patienten,Ersatzwert: 00000000', [8, 8, 'n']] ,
'3104':  ['Titel des Patienten', [0, 15, ALPHANUMERISCH]] ,
'3105':  ['Versichertennummer des Patienten', [6, 12, 'n']] ,
'3107':  ['Straße des Patienten', [0, 28, ALPHANUMERISCH]] ,
'3108':  ['Versichertenart MFR', [1, 1, 'n']] ,
'3110':  ['Geschlecht des Patienten', [1, 1, 'n']] ,
...
'4104':  ['Abrechnungs-VKNR', [5, 5, 'n']] ,
'4106':  ['Kostenträger-Abrechnungsbereich (KTAB)', [2, 2, 'n']] ,
...
'4110':  ['Bis-Datum der Gültigkeit', [4, 4, 'n']] ,
'4111':  ['Krankenkassennummer (IK)', [7, 7, 'n']] ,
'4112':  ['Versichertenstatus', [4, 4, 'n']] ,
'4113':  ['Statusergänzung/DMP-Kennzeichnung', [1, 1, ALPHANUMERISCH]] ,
'4121':  ['Gebührenordnung', [1, 1, 'n']] ,
'4122':  ['Abrechnungsgebiet', [2, 2, 'n']] ,
'4123':  ['Personenkreis / Untersuchungskategorie', [2, 2, 'n']] ,
...
'4202':  ['Unfall, Unfallfolgen', [1, 1, 'n']] ,
'4204':  ['eingeschränkter Leistungsanspruch gemäß \xc2\xa716 Abs. 3a SGB V', [1, 1, 'n']] ,
...
'4217':  ['(N)BSNR des Erstveranlassers', [9, 9, 'n']] ,
'4241':  ['Lebenslange Arztnummer (LANR) des Erstveranlassers Ersatzwert: 999999900', [9, 9, 'n']] ,
'4218':  ['(N)BSNR des Ücberweisers', [9, 9, 'n']] ,
'4242':  ['Lebenslange Arztnummer des Ücberweisers Ersatzwert: 999999900', [9, 9, 'n']] ,
...
'4221':  ['Kurativ / Präventiv / ESS / bei belegärztlicher Behandlung', [1, 1, 'n']] ,
'4229':  ['Ausnahmeindikation', [5, 5, 'n']] ,
'4233':  ['Stationäre Behandlung von ... bis ...', [16, 16, 'n']] ,
'4234':  ['anerkannte Psychotherapie', [1, 1, 'n']] ,
'4235':  ['Datum des Anerkennungsbescheides', [DATUM]] ,
'4239':  ['Scheinuntergruppe', [2, 2, 'n']] ,
'4243':  ['Weiterbehandelnder Arzt Ersatzwert: unbekannt', [0, 60, ALPHANUMERISCH]] ,
'4244':  ['Bewilligte Leistung  5,', [6, 6, ALPHANUMERISCH]] ,
'4245':  ['Anzahl bewilligter Leistungen', [0, 3, 'n']] ,
'4246':  ['Anzahl abgerechneter Leistungen', [0, 3, 'n']] ,
'4247':  ['Antragsdatum Anerkennungsbescheid', [DATUM]] ,
'4261':  ['Kurart', [1, 1, 'n']] ,
'4262':  ['Durchführung als Kompaktkur', [1, 1, 'n']] ,
'4263':  ['genehmigte Kurdauer in Wochen', [0, 2, 'n']] ,
'4264':  ['Anreisetag', [DATUM]] ,
'4265':  ['Abreisetag', [DATUM]] ,
'4266':  ['Kurabbruch am', [DATUM]] ,
'4267':  ['Bewilligte Kurverlängerung in Wochen', [0, 2, 'n']] ,
'4268':  ['Bewilligungsdatum Kurverlängerung', [DATUM]] ,
'4269':  ['Verhaltenspräventive Maßnahmen angeregt', [1, 1, 'n']] ,
'4270':  ['Verhaltenspräventive Maßnahmen durchgeführt', [1, 1, 'n']] ,
'4271':  ['Kompaktkur nicht möglich', [1, 1, 'n']] ,
'5000':  ['Leistungstag', [DATUM]] ,
'5002':  ['Art der Untersuchung', [0, 60, ALPHANUMERISCH]] ,
'5005':  ['Multiplikator', [2, 2, 'n']] ,
'5006':  ['Um-Uhrzeit', [4, 4, 'n']] ,
'5008':  ['DKM', [0, 3, 'n']] ,
'5009':  ['freier Begründungstext', [0, 60, ALPHANUMERISCH]] ,
'5011':  ['Sachkosten-Bezeichnung', [0, 60, ALPHANUMERISCH]] ,
'5012':  ['Sachkosten/Materialkosten in Cent', [0, 10, 'n']] ,
'5013':  ['Prozent der Leistung', [3, 3, 'n']] ,
...
'5020':  ['Wiederholungsuntersuchung', [1, 1, 'n']] ,
'5021':  ['Jahr der letzten Krebsfrüherkennungsuntersuchung', [4, 4, 'n']] ,
...
'5037':  ['Gesamt-Schnitt-Naht-Zeit(Minuten)', [0, 3, 'n']] ,
...
'5042':  ['Mengenangabe KM /AM', [0, 5, 'n']] ,
'5043':  ['Maßeinheit KM /AM', [1, 1, 'n']] ,
'5044':  ['Betriebswirtschaftlich kalkulierter Preis in Cent', [0, 6, 'n']] ,
'5070':  ['OMIM-G-Kode des untersuchten Gens Ersatzwert: 999999', [6, 6, 'n']] ,
'5071':  ['OMIM-P-Kode (Art der Erkrankung) Ersatzwert: 999999', [6, 6, 'n']] ,
'5072':  ['Gen-Name', [0, 60, ALPHANUMERISCH]] ,
'5073':  ['Art der Erkrankung', [0, 60, ALPHANUMERISCH]] ,
'5098':  ['(N)BSNR des Ortes der Leistungserbringung', [9, 9, 'n']] ,
'5099':  ['Lebenslange Arztnummer (LANR) des Leistungserbringers Ersatzwert: 999999900', [9, 9, 'n']] ,
...
'9102':  ['Empfänger', [2, 2, 'n']] ,
'9103':  ['Erstellungsdatum', [DATUM]] ,
'9106':  ['verwendeter Zeichensatz', [1, 1, 'n']] ,
...
'9132':  ['enthaltene Datenpakete dieser Datei', [1, 1, 'n']] ,
'9204':  ['Abrechnungsquartal', [5, 5, 'n']] ,
'9212':  ['Version der Satzbeschreibung', [0, 11, ALPHANUMERISCH]] ,
'9250':  ['AVWG-Prüfnummer der AVS', [15, 17, ALPHANUMERISCH]] ,
'9260':  ['Anzahl Teilabrechnungen', [2, 2, 'n']] ,
'9261':  ['Abrechnungsteil x von y', [2, 2, 'n']] ,
...
# '3673':  ['Dauerdiagnose (ICD-Code)', [3, 3, 5, 6, ALPHANUMERISCH]],
# '4236':  ['Abklärung somatischer Ursachen vor Aufnahme einer Psychotherapie', [ALPHANUMERISCH]],
# '5001':  ['Gebührennummer (GNR)', [5, 9, GOP]],
# '6001':  ['ICD-Code Ersatzwert: UUU', [3, 3, 5, 6, ALPHANUMERISCH]]
...
def check_feldkennung(t):
    ...
    if not(t[0] in ALLE_FELDKENNUNGEN):
        return False, "Unbekannte Feldkennung '"+t[0]+"'"
    else:
        info = ALLE_FELDKENNUNGEN[t[0]]
        err = ""
        if not check_length(info[1], t[1]):
            err += "Längenrestriktion nicht eingehalten!\n"
        if  not check_value(info[1], t[1]):
